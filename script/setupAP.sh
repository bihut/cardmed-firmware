...
#Example of use:
#sudo ./setup-network.sh --install --ap-ssid="cardmed-AP" --ap-password="cardmedpw" --ap-password-encrypt --ap-country-code="GB" --ap-ip-address="10.0.0.1" --wifi-interface="wlan0"
